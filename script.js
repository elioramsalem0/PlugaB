...
const soldiers = {
    "מחלקה 1": ["אבנר לוי", "איגור חביבובלין", "אמיר דו בלוך", "אסף אופיר", "הלל בנאמו", "חביב דדון", "לוי יצחק דובאוו", "לירון פוריאן", "פבל אבירם", "עדן מור"],
    ...
    "מחלקה 3": ["דניאל יונתן", "אביבה קללאו", "אופיר מזרחי", "דקל חן", "מאור גבאי", "נועם גזית", "רקפת זיו", "שיר דקלו"],
    ...
    "מסופחים": ["אופיר אלזרט","הגר אלון","שושנה מולר","מנחם קרול ג׳קי","יובל שלום","שחר בלוך"],
  ...
  <Table ss:ExpandedColumnCount="10" ss:ExpandedRowCount="1000" x:FullColumns="1" x:FullRows="1" ss:DefaultColumnWidth="70" ss:DefaultRowHeight="15">
   ...
   <Row ss:Index="${currentRow}">
    <Cell ss:MergeAcross="9"><Data ss:Type="String"></Data></Cell>
            ...
            const units = ["מחלקה 1", "מחלקה 2", "מחלקה 3", "מפלג", "מסופחים", "חמליסטים"];
